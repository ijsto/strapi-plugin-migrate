...
import { Button, LoadingBar, Textarea } from '@buffetjs/core'
...
const UploadFileForm = () => {
  ...
  const handleRetrieve = async () => {
    ...
    try {
      const response = await request("/migrate/retrieveSqlString", { method: "GET" });
  ...
  return (
    ...
    <div style={{ padding: "1.8rem 1.5rem" }}>
      ...
      <div>You will get a raw SQL query that you will be able to paste in another environment (for example staging, production).</div>
